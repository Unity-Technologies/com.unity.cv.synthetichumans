...
class SyntheticHumanTabButton : VisualElement
{
    internal new class UxmlFactory : UxmlFactory<SyntheticHumanTabButton, UxmlTraits> { }
    ...
    internal new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        {
            base.Init(ve, bag, cc);
            SyntheticHumanTabButton item = ve as SyntheticHumanTabButton;
    ...
    public event Action<SyntheticHumanTabButton> OnSelect;
    public event Action<SyntheticHumanTabButton> OnClose;

    public SyntheticHumanTabButton()
    {
        Init();
    }

    public SyntheticHumanTabButton(string text, VisualElement target)
    {
        Init();
        m_Label.text = text;
        Target = target;
